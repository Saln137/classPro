...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				教师管理 <small>全部老师</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/index.jsp"><i
						class="fa fa-dashboard"></i> 首页</a></li>
				<li><a
					href="${pageContext.request.contextPath}/user/findAll.do">教师管理</a></li>

				<li class="active">全部老师</li>
			</ol>
			</section>
			<!-- 内容头部 /-->
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/teacher/saveUI'">
							...
							<table id="dataList"
								...
								<c:forEach items="${teacherList}" var="teacher">
										<tr>
											...
											<td class="text-center">
												<a href="javascript:void(0);" onclick="userDel('${user.id}');" class="btn bg-olive btn-xs">删除</a>
											</td>
										</tr>
								</c:forEach>
								</tbody>
